...
export class UserUpdateFormGroup extends FormGroup {
    ...
    constructor() {
        super({
            ...
            gender: new UserUpdateFormControl("Gender", "gender",'', Validators.required),
            phone_number: new UserUpdateFormControl("Phone Number", "phoneNumber", "", Validators.required),
            date_of_birth: new UserUpdateFormControl("Birthday", "birthday", '', Validators.required),
            ...
            password: new UserUpdateFormControl("Password", "Password", "", Validators.compose([
                    Validators.required,
                    Validators.minLength(8),
                    Validators.maxLength(20)
                ])),
            confirmPassword: new UserUpdateFormControl("Confirm Password", "confirmPassword", "",
                Validators.compose([
                    Validators.required,
                    Validators.minLength(8),
                    Validators.maxLength(20)
                ])),
            is_active: new EmployeeIDInformationFormControl("Active", "is_active", "", Validators.required),
            is_superuser: new EmployeeIDInformationFormControl("Superuser", "is_superuser", "", Validators.required),
    ...
    getPasswordValidationMessages(password: string): string[] {
        return (this.controls['password'] as UserUpdateFormControl).getValidationMessages();
    }

    getConfirmPasswordValidationMessages(confirmPassword: string): string[] {
        return (this.controls['confirmPassword'] as UserUpdateFormControl).getValidationMessages();
    }
    getIsActiveValidationMessages(is_active: string): string[] {
        return (this.controls['is_active'] as EmployeeIDInformationFormControl).getValidationMessages();
    }
    getIsSuperuserValidationMessages(is_superuser: string): string[] {
        return (this.controls['is_superuser'] as EmployeeIDInformationFormControl).getValidationMessages();
    }
