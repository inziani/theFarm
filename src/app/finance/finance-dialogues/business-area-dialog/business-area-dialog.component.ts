...
import { BusinessAreaMasterData, CompanyCodeMasterData } from '@app/finance/finance-models/fi-data-models/organization-data-models';
...
export class BusinessAreaDialogComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public businessAreaDialogueData: BusinessAreaMasterData
  ) { }
